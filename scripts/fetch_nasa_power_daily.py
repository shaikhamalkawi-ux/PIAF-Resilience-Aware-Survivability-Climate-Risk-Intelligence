...
This acquisition script is separate from run_analysis.py. It requires internet
access and documents the route to the upstream daily source data. The journal
revision uses the committed climate-summary table so that later changes to the
live NASA service cannot silently alter the submitted numerical results.
"""
